...
<head>
    ...
    <style>
        ...
        *::-webkit-scrollbar {
        ...
        .hms-cell:nth-child(2) {
            border-right: none;
        }

        .hms-cell:nth-child(3),
        .hms-cell:nth-child(4) {
            border-top: 1px solid var(--border);
        }
        ...
        @keyframes pulse {
            ...
            50% {
                box-shadow: 0 0 16px var(--blue-glow), 0 0 24px rgba(37, 99, 235, 0.2);
            }
        }
