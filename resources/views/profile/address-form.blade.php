...
@section('content')
    ...
    <div class="max-w-4xl mx-auto pb-20">
        ...
        <form action="{{ isset($address) ? route('address.update', $address->id) : route('address.store') }}" method="POST"
            ...
            ═══════════════════════════════════════ --}}
                <div
                    class="bg-[#0a0a0a] border border-white/10 rounded-xl p-6 md:p-8 hover:border-white/20 transition-colors">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="flex gap-3 flex-wrap">
                                @foreach (['Home', 'Office', 'Other'] as $lbl)
                                    <label class="cursor-pointer">
                                        <input type="radio" name="label" value="{{ $lbl }}"
                                            class="peer sr-only"
                                            {{ old('label', $address->label ?? 'Home') === $lbl ? 'checked' : '' }}>
                                        <div
                                            class="px-5 py-2.5 rounded-lg border-2 border-white/10 text-gray-400 text-sm font-bold
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span
                                    class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm font-bold">+62</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <div class="custom-select" id="dd_province">
                                <button type="button"
                                    class="dd-trigger w-full flex items-center justify-between bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-gray-500 hover:border-blue-500/50 transition-all">
                                    <span class="dd-label truncate">— Pilih Provinsi —</span>
                                    <span
                                        class="material-symbols-outlined text-gray-500 text-sm shrink-0 transition-transform duration-200">expand_more</span>
                                </button>
                                <div
                                    class="dd-menu hidden absolute z-50 mt-1 w-full bg-[#111] border border-white/10 rounded-lg shadow-2xl overflow-hidden">
                                    <div class="p-2 border-b border-white/10">
                                        <input type="text"
                                            class="dd-search w-full bg-white/5 rounded px-3 py-1.5 text-xs text-white placeholder-gray-600 outline-none"
                        ...
                        <div>
                            ...
                            <div class="custom-select disabled" id="dd_city">
                                <button type="button" disabled
                                    class="dd-trigger w-full flex items-center justify-between bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-gray-600 cursor-not-allowed opacity-50 transition-all">
                                    <span class="dd-label truncate">— Pilih Kota —</span>
                                    <span
                                        class="material-symbols-outlined text-gray-600 text-sm shrink-0">expand_more</span>
                                </button>
                                <div
                                    class="dd-menu hidden absolute z-50 mt-1 w-full bg-[#111] border border-white/10 rounded-lg shadow-2xl overflow-hidden">
                                    <div class="p-2 border-b border-white/10">
                ...
                <div
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="full_address" rows="3" placeholder="Nama jalan, nomor rumah, RT/RW, patokan, dll."
                                class="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white text-sm
                        ...
                        <div>
                            <label class="flex items-center gap-3 cursor-pointer group w-max select-none">
                                <div class="relative flex items-center justify-center">
                                    ...
                                    <div
                                        class="w-5 h-5 border-2 border-white/20 rounded bg-white/5
