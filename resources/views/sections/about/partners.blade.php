<div class="scroll-trigger opacity-0 py-16 md:py-24 px-4 border-t border-white/5 bg-[#050014]">
    <div class="max-w-[1440px] mx-auto text-center">
        <p class="text-[10px] md:text-xs font-black text-gray-500 uppercase tracking-[0.4em] mb-10 md:mb-16">
            Strategic Hardware Alliance
        </p>

        <div class="flex flex-wrap justify-center items-center gap-y-12 gap-x-8 sm:gap-x-12 md:gap-x-20 lg:gap-x-24 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-[#76b900]">
                <div class="h-6 sm:h-8 md:h-11">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">NVIDIA</span>
            </div>

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-[#0071c5]">
                <div class="h-8 sm:h-10 md:h-14">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto fill-current">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">INTEL</span>
            </div>

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-[#ed1c24]">
                <div class="h-6 sm:h-7 md:h-10">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto fill-current">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">AMD</span>
            </div>

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-[#FF0000]">
                <div class="h-8 sm:h-10 md:h-14">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto fill-current">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">MSI GAMING</span>
            </div>

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-[#FF5722]">
                <div class="h-7 sm:h-9 md:h-12">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto fill-current">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">AORUS</span>
            </div>

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-white">
                <div class="h-8 sm:h-10 md:h-14">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto fill-current">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">ROG ELITE</span>
            </div>

            <div class="flex flex-col items-center gap-3 md:gap-4 group transition-colors hover:text-[#F5C900]">
                <div class="h-8 sm:h-10 md:h-14">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-full w-auto fill-current">
                ...
                <span class="font-gaming text-[9px] md:text-xs tracking-[0.2em]">CORSAIR</span>
            </div>
