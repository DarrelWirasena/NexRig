...
@section('content')
        ...
        <div class="max-w-[1440px] mx-auto relative z-10">
            <div class="flex flex-col md:flex-row justify-between items-end gap-6 mb-12">
                ...
                <div class="hidden md:flex gap-2">
                    <a href="{{ route('articles.index') }}" class="px-4 py-2 text-xs font-bold uppercase tracking-wider border border-primary text-white bg-primary/10 transition-all clip-button">
                        All
                    </a>
                    {{-- Anda bisa mem-hardcode kategori atau mengambil dari pluck('category') --}}
                    @foreach(['Engineering', 'Hardware', 'Reviews', 'Community'] as $filter)
                        <button class="px-4 py-2 text-xs font-bold uppercase tracking-wider border border-white/10 text-gray-400 hover:text-white hover:border-primary hover:bg-primary/10 transition-all clip-button">
                            {{ $filter }}
                        </button>
                    @endforeach
                </div>
            ...
            {{-- FEATURED ARTICLE (Mengambil item pertama dari $articles) --}}
            @if($articles->count() > 0)
                ...
                <div class="relative w-full h-[500px] rounded-2xl overflow-hidden group border border-white/10 hover:border-primary/50 transition-colors duration-500">
                    ...
                    <div class="absolute bottom-0 left-0 p-6 md:p-12 max-w-4xl z-10 text-left">
                        ...
                        <div class="inline-flex items-center gap-2 text-white font-bold uppercase tracking-widest text-xs group-hover:translate-x-2 transition-transform">
    ...
    <div class="bg-[#050505] py-16 px-4">
        <div class="max-w-[1440px] mx-auto">
            
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {{-- Lewati item pertama karena sudah jadi Featured di atas --}}
    ...
    <div class="bg-gradient-to-b from-[#050505] to-[#0a0a0a] py-24 border-t border-white/5">
        <div class="max-w-4xl mx-auto px-4 text-center text-left">
            <span class="material-symbols-outlined text-6xl text-primary mb-4 animate-bounce">mail</span>
            <h2 class="text-3xl md:text-5xl font-black text-white uppercase italic mb-4 text-center">Don't Miss the Drop</h2>
            <p class="text-gray-400 mb-8 max-w-lg mx-auto text-center">Get the latest build guides, hardware reviews, and exclusive NexRig offers delivered directly to your inbox.</p>
